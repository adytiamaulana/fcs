...
import { sampleWithRequiredData } from '../personal-info.test-samples';
...
describe('PersonalInfo Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.personalInfos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to personalInfoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPersonalInfoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPersonalInfoIdentifier).toHaveBeenCalledWith(entity);
