...
describe('PersonalInfo Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call address query and add missing value', () => {
      ...
      const address: IAddress = { id: 491 };
      personalInfo.address = address;

      const addressCollection: IAddress[] = [{ id: 17881 }];
    ...
    it('Should call cardType query and add missing value', () => {
      const personalInfo: IPersonalInfo = { id: 456 };
      const cardType: ICardType = { id: 21760 };
      personalInfo.cardType = cardType;

      const cardTypeCollection: ICardType[] = [{ id: 23360 }];
    ...
    it('Should update editForm', () => {
      const personalInfo: IPersonalInfo = { id: 456 };
      const address: IAddress = { id: 7616 };
      personalInfo.address = address;
      const cardType: ICardType = { id: 17642 };
      personalInfo.cardType = cardType;
