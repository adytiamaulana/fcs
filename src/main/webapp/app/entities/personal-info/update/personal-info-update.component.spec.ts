...
describe('PersonalInfo Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call address query and add missing value', () => {
      ...
      const address: IAddress = { id: 6566 };
      personalInfo.address = address;

      const addressCollection: IAddress[] = [{ id: 17689 }];
    ...
    it('Should call cardType query and add missing value', () => {
      const personalInfo: IPersonalInfo = { id: 456 };
      const cardType: ICardType = { id: 6766 };
      personalInfo.cardType = cardType;

      const cardTypeCollection: ICardType[] = [{ id: 7323 }];
    ...
    it('Should update editForm', () => {
      const personalInfo: IPersonalInfo = { id: 456 };
      const address: IAddress = { id: 164 };
      personalInfo.address = address;
      const cardType: ICardType = { id: 12691 };
      personalInfo.cardType = cardType;
