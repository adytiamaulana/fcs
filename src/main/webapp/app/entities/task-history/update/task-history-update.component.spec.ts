...
describe('TaskHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call personalInfo query and add missing value', () => {
      ...
      const personalInfo: IPersonalInfo = { id: 4292 };
      taskHistory.personalInfo = personalInfo;

      const personalInfoCollection: IPersonalInfo[] = [{ id: 31803 }];
    ...
    it('Should call applicationStatus query and add missing value', () => {
      const taskHistory: ITaskHistory = { id: 456 };
      const applicationStatus: IApplicationStatus = { id: 19041 };
      taskHistory.applicationStatus = applicationStatus;

      const applicationStatusCollection: IApplicationStatus[] = [{ id: 11183 }];
    ...
    it('Should update editForm', () => {
      const taskHistory: ITaskHistory = { id: 456 };
      const personalInfo: IPersonalInfo = { id: 5967 };
      taskHistory.personalInfo = personalInfo;
      const applicationStatus: IApplicationStatus = { id: 28366 };
      taskHistory.applicationStatus = applicationStatus;
