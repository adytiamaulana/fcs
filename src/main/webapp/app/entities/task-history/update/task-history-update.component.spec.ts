...
describe('TaskHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call personalInfo query and add missing value', () => {
      ...
      const personalInfo: IPersonalInfo = { id: 22335 };
      taskHistory.personalInfo = personalInfo;

      const personalInfoCollection: IPersonalInfo[] = [{ id: 9705 }];
    ...
    it('Should call applicationStatus query and add missing value', () => {
      const taskHistory: ITaskHistory = { id: 456 };
      const applicationStatus: IApplicationStatus = { id: 16803 };
      taskHistory.applicationStatus = applicationStatus;

      const applicationStatusCollection: IApplicationStatus[] = [{ id: 28739 }];
    ...
    it('Should update editForm', () => {
      const taskHistory: ITaskHistory = { id: 456 };
      const personalInfo: IPersonalInfo = { id: 15243 };
      taskHistory.personalInfo = personalInfo;
      const applicationStatus: IApplicationStatus = { id: 17510 };
      taskHistory.applicationStatus = applicationStatus;
