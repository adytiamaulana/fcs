...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../task-history.test-samples';

import { TaskHistoryService, RestTaskHistory } from './task-history.service';

const requireRestSample: RestTaskHistory = {
