...
import { sampleWithRequiredData } from '../application-status.test-samples';
...
describe('ApplicationStatus Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.applicationStatuses?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to applicationStatusService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getApplicationStatusIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getApplicationStatusIdentifier).toHaveBeenCalledWith(entity);
