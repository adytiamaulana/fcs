...
export class ApplicationStatusService {
  ...
  protected convertDateFromClient<T extends IApplicationStatus | NewApplicationStatus | PartialUpdateApplicationStatus>(
    ...
    return {
      ...applicationStatus,
      createdAt: applicationStatus.createdAt?.format(DATE_FORMAT) ?? null,
      updatedAt: applicationStatus.updatedAt?.format(DATE_FORMAT) ?? null,
      deletedAt: applicationStatus.deletedAt?.format(DATE_FORMAT) ?? null,
    };
  }
