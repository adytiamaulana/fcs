...
public class PersonalInfo implements Serializable {
    ...
    public PersonalInfo branch(Integer branch) {
    ...
    public PersonalInfo createdAt(Instant createdAt) {
    ...
    public PersonalInfo updatedAt(Instant updatedAt) {
    ...
    public PersonalInfo deletedAt(Instant deletedAt) {
