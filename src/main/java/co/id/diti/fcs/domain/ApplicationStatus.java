...
public class ApplicationStatus implements Serializable {
    ...
    public ApplicationStatus createdAt(String createdAt) {
    ...
    public ApplicationStatus updatedAt(String updatedAt) {
    ...
    public ApplicationStatus deletedAt(String deletedAt) {
