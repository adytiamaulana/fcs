...
import co.id.diti.fcs.config.Constants;
import co.id.diti.fcs.domain.User;
import co.id.diti.fcs.repository.UserRepository;
import co.id.diti.fcs.security.AuthoritiesConstants;
import co.id.diti.fcs.service.MailService;
import co.id.diti.fcs.service.UserService;
import co.id.diti.fcs.service.dto.AdminUserDTO;
import co.id.diti.fcs.web.rest.errors.BadRequestAlertException;
import co.id.diti.fcs.web.rest.errors.EmailAlreadyUsedException;
import co.id.diti.fcs.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link co.id.diti.fcs.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
