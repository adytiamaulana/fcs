...
/**
 * REST controller for managing {@link co.id.diti.fcs.domain.TaskHistory}.
 */
@RestController
...
public class TaskHistoryResource {
    ...
    public ResponseEntity<TaskHistory> createTaskHistory(@RequestBody TaskHistory taskHistory) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/task-histories/" + taskHistory.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, taskHistory.getId().toString()))
            .body(taskHistory);
    }
    ...
    public ResponseEntity<TaskHistory> updateTaskHistory(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, taskHistory.getId().toString()))
            .body(taskHistory);
    }
    ...
    public ResponseEntity<TaskHistory> partialUpdateTaskHistory(
        ...
        Optional<TaskHistory> result = taskHistoryRepository
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, taskHistory.getId().toString())
        );
    }
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<TaskHistory>> getAllTaskHistories(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
