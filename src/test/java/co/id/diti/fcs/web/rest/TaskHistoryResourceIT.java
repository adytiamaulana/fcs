...
class TaskHistoryResourceIT {
    ...
    public static TaskHistory createEntity(EntityManager em) {
        TaskHistory taskHistory = new TaskHistory().startDate(DEFAULT_START_DATE).endDate(DEFAULT_END_DATE);
        return taskHistory;
    }
    ...
    public static TaskHistory createUpdatedEntity(EntityManager em) {
        TaskHistory taskHistory = new TaskHistory().startDate(UPDATED_START_DATE).endDate(UPDATED_END_DATE);
        return taskHistory;
    }
    ...
    void putExistingTaskHistory() throws Exception {
        ...
        updatedTaskHistory.startDate(UPDATED_START_DATE).endDate(UPDATED_END_DATE);
    ...
    void partialUpdateTaskHistoryWithPatch() throws Exception {
        ...
        partialUpdatedTaskHistory.startDate(UPDATED_START_DATE);
    ...
    void fullUpdateTaskHistoryWithPatch() throws Exception {
        ...
        partialUpdatedTaskHistory.startDate(UPDATED_START_DATE).endDate(UPDATED_END_DATE);
