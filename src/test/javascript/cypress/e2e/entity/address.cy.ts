...
describe('Address e2e test', () => {
  ...
  describe('new Address page', () => {
    ...
    it('should create an instance of Address', () => {
      ...
      cy.get(`[data-cy="createdAt"]`).type('2024-08-12T04:13');
      cy.get(`[data-cy="createdAt"]`).blur();
      cy.get(`[data-cy="createdAt"]`).should('have.value', '2024-08-12T04:13');
      ...
      cy.get(`[data-cy="deletedAt"]`).type('2024-08-12T04:02');
      cy.get(`[data-cy="deletedAt"]`).blur();
      cy.get(`[data-cy="deletedAt"]`).should('have.value', '2024-08-12T04:02');
