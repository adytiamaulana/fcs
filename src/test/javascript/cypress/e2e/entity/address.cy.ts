...
describe('Address e2e test', () => {
  ...
  describe('new Address page', () => {
    ...
    it('should create an instance of Address', () => {
      ...
      cy.get(`[data-cy="createdAt"]`).type('2024-08-12T03:02');
      cy.get(`[data-cy="createdAt"]`).blur();
      cy.get(`[data-cy="createdAt"]`).should('have.value', '2024-08-12T03:02');

      cy.get(`[data-cy="updatedBy"]`).type('jolly');
      cy.get(`[data-cy="updatedBy"]`).should('have.value', 'jolly');

      cy.get(`[data-cy="updatedAt"]`).type('2024-08-12T02:43');
      cy.get(`[data-cy="updatedAt"]`).blur();
      cy.get(`[data-cy="updatedAt"]`).should('have.value', '2024-08-12T02:43');

      cy.get(`[data-cy="deletedBy"]`).type('steer whose');
      cy.get(`[data-cy="deletedBy"]`).should('have.value', 'steer whose');

      cy.get(`[data-cy="deletedAt"]`).type('2024-08-12T02:52');
      cy.get(`[data-cy="deletedAt"]`).blur();
      cy.get(`[data-cy="deletedAt"]`).should('have.value', '2024-08-12T02:52');
