...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '6b5cf214-1a3e-4cf5-8afe-45b78dec9b68' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('72c42688-7ce8-453f-863c-48a05c93a77c');
      cy.get(`[data-cy="name"]`).should('have.value', '72c42688-7ce8-453f-863c-48a05c93a77c');
