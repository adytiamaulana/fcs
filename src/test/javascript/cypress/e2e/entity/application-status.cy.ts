...
describe('ApplicationStatus e2e test', () => {
  ...
  describe('new ApplicationStatus page', () => {
    ...
    it('should create an instance of ApplicationStatus', () => {
      cy.get(`[data-cy="code"]`).type('lumbering drat wherever');
      cy.get(`[data-cy="code"]`).should('have.value', 'lumbering drat wherever');

      cy.get(`[data-cy="status"]`).type('lacerate authentication after');
      cy.get(`[data-cy="status"]`).should('have.value', 'lacerate authentication after');

      cy.get(`[data-cy="createdBy"]`).type('hm fast');
      cy.get(`[data-cy="createdBy"]`).should('have.value', 'hm fast');

      cy.get(`[data-cy="createdAt"]`).type('2024-08-11T17:58');
      cy.get(`[data-cy="createdAt"]`).blur();
      cy.get(`[data-cy="createdAt"]`).should('have.value', '2024-08-11T17:58');

      cy.get(`[data-cy="updatedBy"]`).type('drat instead');
      cy.get(`[data-cy="updatedBy"]`).should('have.value', 'drat instead');

      cy.get(`[data-cy="updatedAt"]`).type('2024-08-11T20:53');
      cy.get(`[data-cy="updatedAt"]`).blur();
      cy.get(`[data-cy="updatedAt"]`).should('have.value', '2024-08-11T20:53');

      cy.get(`[data-cy="deletedBy"]`).type('tuna');
      cy.get(`[data-cy="deletedBy"]`).should('have.value', 'tuna');

      cy.get(`[data-cy="deletedAt"]`).type('2024-08-12T00:03');
      cy.get(`[data-cy="deletedAt"]`).blur();
      cy.get(`[data-cy="deletedAt"]`).should('have.value', '2024-08-12T00:03');
