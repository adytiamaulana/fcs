...
describe('CardType e2e test', () => {
  ...
  describe('new CardType page', () => {
    ...
    it('should create an instance of CardType', () => {
      ...
      cy.get(`[data-cy="createdAt"]`).type('2024-08-11T17:09');
      cy.get(`[data-cy="createdAt"]`).blur();
      cy.get(`[data-cy="createdAt"]`).should('have.value', '2024-08-11T17:09');

      cy.get(`[data-cy="updatedBy"]`).type('knot fluster input');
      cy.get(`[data-cy="updatedBy"]`).should('have.value', 'knot fluster input');

      cy.get(`[data-cy="updatedAt"]`).type('2024-08-12T06:16');
      cy.get(`[data-cy="updatedAt"]`).blur();
      cy.get(`[data-cy="updatedAt"]`).should('have.value', '2024-08-12T06:16');

      cy.get(`[data-cy="deletedBy"]`).type('and');
      cy.get(`[data-cy="deletedBy"]`).should('have.value', 'and');

      cy.get(`[data-cy="deletedAt"]`).type('2024-08-12T03:04');
      cy.get(`[data-cy="deletedAt"]`).blur();
      cy.get(`[data-cy="deletedAt"]`).should('have.value', '2024-08-12T03:04');
