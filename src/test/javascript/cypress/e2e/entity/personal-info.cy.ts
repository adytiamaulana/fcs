...
describe('PersonalInfo e2e test', () => {
  ...
  describe('new PersonalInfo page', () => {
    ...
    it('should create an instance of PersonalInfo', () => {
      cy.get(`[data-cy="name"]`).type('decimal geez finally');
      cy.get(`[data-cy="name"]`).should('have.value', 'decimal geez finally');

      cy.get(`[data-cy="gender"]`).type('plot early');
      cy.get(`[data-cy="gender"]`).should('have.value', 'plot early');

      cy.get(`[data-cy="birthDate"]`).type('if leaker');
      cy.get(`[data-cy="birthDate"]`).should('have.value', 'if leaker');

      cy.get(`[data-cy="telephone"]`).type('496.758.0037');
      cy.get(`[data-cy="telephone"]`).should('have.value', '496.758.0037');

      cy.get(`[data-cy="branch"]`).type('10326');
      cy.get(`[data-cy="branch"]`).should('have.value', '10326');

      cy.get(`[data-cy="createdBy"]`).type('provided unless resolution');
      cy.get(`[data-cy="createdBy"]`).should('have.value', 'provided unless resolution');

      cy.get(`[data-cy="createdAt"]`).type('2024-08-12T09:07');
      cy.get(`[data-cy="createdAt"]`).blur();
      cy.get(`[data-cy="createdAt"]`).should('have.value', '2024-08-12T09:07');

      cy.get(`[data-cy="updatedBy"]`).type('uncoil');
      cy.get(`[data-cy="updatedBy"]`).should('have.value', 'uncoil');

      cy.get(`[data-cy="updatedAt"]`).type('2024-08-12T03:53');
      cy.get(`[data-cy="updatedAt"]`).blur();
      cy.get(`[data-cy="updatedAt"]`).should('have.value', '2024-08-12T03:53');

      cy.get(`[data-cy="deletedBy"]`).type('fondly wherever tail');
      cy.get(`[data-cy="deletedBy"]`).should('have.value', 'fondly wherever tail');

      cy.get(`[data-cy="deletedAt"]`).type('2024-08-12T12:44');
      cy.get(`[data-cy="deletedAt"]`).blur();
      cy.get(`[data-cy="deletedAt"]`).should('have.value', '2024-08-12T12:44');
