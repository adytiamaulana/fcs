...
describe('PersonalInfo e2e test', () => {
  ...
  describe('new PersonalInfo page', () => {
    ...
    it('should create an instance of PersonalInfo', () => {
      ...
      cy.get(`[data-cy="createdAt"]`).type('2024-08-11T16:20');
      cy.get(`[data-cy="createdAt"]`).blur();
      cy.get(`[data-cy="createdAt"]`).should('have.value', '2024-08-11T16:20');

      cy.get(`[data-cy="updatedBy"]`).type('worn');
      cy.get(`[data-cy="updatedBy"]`).should('have.value', 'worn');

      cy.get(`[data-cy="updatedAt"]`).type('2024-08-12T08:30');
      cy.get(`[data-cy="updatedAt"]`).blur();
      cy.get(`[data-cy="updatedAt"]`).should('have.value', '2024-08-12T08:30');

      cy.get(`[data-cy="deletedBy"]`).type('near');
      cy.get(`[data-cy="deletedBy"]`).should('have.value', 'near');

      cy.get(`[data-cy="deletedAt"]`).type('2024-08-12T02:21');
      cy.get(`[data-cy="deletedAt"]`).blur();
      cy.get(`[data-cy="deletedAt"]`).should('have.value', '2024-08-12T02:21');
