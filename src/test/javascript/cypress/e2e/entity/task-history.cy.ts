...
describe('TaskHistory e2e test', () => {
  ...
  describe('TaskHistory page', () => {
    ...
    describe('with existing value', () => {
      ...
      it.skip('edit button click should load edit TaskHistory page and save', () => {
        cy.get(entityEditButtonSelector).first().click();
        cy.getEntityCreateUpdateHeading('TaskHistory');
  ...
  describe('new TaskHistory page', () => {
    ...
    it('should create an instance of TaskHistory', () => {
      cy.get(`[data-cy="branch"]`).type('caring above veil');
      cy.get(`[data-cy="branch"]`).should('have.value', 'caring above veil');

      cy.get(`[data-cy="startDate"]`).type('2024-08-12');
      cy.get(`[data-cy="startDate"]`).blur();
      cy.get(`[data-cy="startDate"]`).should('have.value', '2024-08-12');

      cy.get(`[data-cy="endDate"]`).type('2024-08-11');
      cy.get(`[data-cy="endDate"]`).blur();
      cy.get(`[data-cy="endDate"]`).should('have.value', '2024-08-11');
