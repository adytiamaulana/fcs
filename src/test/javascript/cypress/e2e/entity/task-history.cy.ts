...
describe('TaskHistory e2e test', () => {
  ...
  describe('new TaskHistory page', () => {
    ...
    it('should create an instance of TaskHistory', () => {
      cy.get(`[data-cy="startDate"]`).type('2024-08-12T06:23');
      cy.get(`[data-cy="startDate"]`).blur();
      cy.get(`[data-cy="startDate"]`).should('have.value', '2024-08-12T06:23');

      cy.get(`[data-cy="endDate"]`).type('2024-08-11T17:09');
      cy.get(`[data-cy="endDate"]`).blur();
      cy.get(`[data-cy="endDate"]`).should('have.value', '2024-08-11T17:09');
